...
const items = [
  ...
  { to: "/characters/meet", label: "Meet Characters" },
  ...
  { to: "/mall/products", label: "Products", permission: "mall.read" },
  { to: "/vendor/advertising", label: "Vendor Ads" },
  ...
  { to: "/studio/booklets", label: "Booklet Builder", permission: "library.read" },
  ...
  { to: "/studio/commerce", label: "Commerce", permission: "commerce.read" },
  { to: "/studio/advertising", label: "Advertising", permission: "advertising.manage" },
  { to: "/studio/analytics", label: "Analytics", permission: "analytics.read" },
