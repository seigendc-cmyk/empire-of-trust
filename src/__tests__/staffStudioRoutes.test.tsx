...
vi.mock('../components/staff/StaffPages', () => ({
  ...
  StaffRequestAccessPage: () => <div>REQUEST ACCESS</div>,
  StaffPendingPage: () => <div>PENDING APPROVAL</div>,
  StaffAccessRejectedPage: () => <div>ACCESS REJECTED</div>,
  StaffAccessRequestsPage: () => <div>ACCESS REQUESTS</div>,
